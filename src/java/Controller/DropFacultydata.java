...
public class DropFacultydata extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      response.setContentType("text/html;charset=UTF-8");
        ...
        Query query = session.createQuery(" delete from DatabaseData where Name = :s1 AND Number =:s2 AND Fathercontact =:s3");
        ...
        response.sendRedirect("DisplayFacultyServlet");
    }
