  ...
  color: white;
    ...
    <body>
        ...
        <table class="student" align="center" >
            <tr><th colspan="8" style="font-size: 30px;">STUDENT DATABASE</th></tr>
            <tr>
                <th>Sr. No</th>
                <th>Username</th>
                <th>NAME</th>
    ...
    out.println("<a  href='DropStudentData?namedrop="+disp.getName()+"&Contactdrop="+disp.getNumber()+"&FatherContactdrop="+disp.getFathercontact()+"'>Remove</a>");
