...
<html>
    <head>
        ...
        <script src="jquery.js">
               ...
               <script src="myFaculty.js"></script>
...
#option1,#option2,#option4,#option5,#option6{
    ...
    try
    {
        ...
        <div class="header">
            ...
            <h1 class="w3-xxxlarge" style="border:none;text-decoration:underline;display: flex;flex-wrap: wrap;  min-width: 900px;">
                ...
                Bus Management<span class="adm">FACULTY</span></h1>
...
<div class="formpopup" id="myForm">
  <form action="ComplaintData" class="form-container">
      <input type="hidden" name="dept" value="Faculty">
...
<!--  <button onclick="my()" id="dash">Dashboard</button>-->
   ...
   <button id="student">Faculty</button>
   <button id="studata">Student Data</button>
                            ...
                            <form action="RouteChangeRequest" method="post">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="hidden" name="stud" value="Faculty">
                                                <input type="tel" maxlength="10" style="width:250px;" name="reqId"></td>
                                        </tr>
                                    <tr>
                                        <td>Reason</td></tr>
                                    <tr>
                        ...
                        <div class="op6-left">
                            <form>
                                <table cellpadding="5" align="center">
                                    ...
                                    <tr><td>ID</td><td>:</td><td><input type="number"></td></tr>
                                    <tr><td>Email</td><td>:</td><td><input type="email"></td></tr>
                                    <tr><td>Mobile</td><td>:</td><td><input type="number"></td></tr>
                                    <tr><td></td><td></td>
